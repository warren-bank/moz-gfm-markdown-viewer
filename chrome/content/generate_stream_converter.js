...
if (! GFM_MarkdownViewer.StreamConverters){
	GFM_MarkdownViewer.StreamConverters = {};
}
...
if (typeof generate_stream_converter !== 'function'){
	...
	var generate_stream_converter = function(class_description, class_id, from_mime_type){
		...
		if (typeof GFM_MarkdownViewer.StreamConverters[class_id] === 'function'){return;}

		GFM_MarkdownViewer.StreamConverters[class_id] = function() {};

		GFM_MarkdownViewer.StreamConverters[class_id].prototype = {
			...
			_xpcom_factory: {
				createInstance: function(outer, iid) {
					...
					if (iid.equals(Components.interfaces.nsISupports) ||
						...
						return new GFM_MarkdownViewer.StreamConverters[class_id]();
					}
